    ...
    public function run(): void
    {
        $services = [
            [
                ...
                'image' => asset('backend/img/design.png'),
                'slug' => 'design',
                'status' => 'active',
            ],
            [
                ...
                'image' => asset('backend/img/fulfillment.png'),
                'slug' => 'fulfillment',
                'status' => 'active',
            ],
            [
                ...
                'image' => asset('backend/img/storage.png'),
            ...
            [
                ...
                'image' => asset('backend/img/microsites.png'),
                'slug' => 'microsites',
                'status' => 'active',
            ],
            [
                ...
                'image' => asset('backend/img/redemption.png'),
            ...
            [
                ...
                'image' => asset('backend/img/influencer.png'),
            ...
            [
                ...
                'image' => asset('backend/img/tools.png'),
