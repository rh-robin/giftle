    ...
    public function run(): void
    {
        $gifting = [
            [
                ...
                'image' => 'backend/img/gift-package-1-Cg0gNPzi.png.png',
                'slug' => 'welcome-packs',
                'status' => 'active',
            ],
            [
                ...
                'image' => 'backend/img/gift-package-2-B_nXYNio.png',
                'slug' => 'milestones',
                'status' => 'active',
            ],
            [
                ...
                'image' => 'backend/img/gift-package-3-U8yye1PM.png',
            ...
            [
                ...
                'image' => 'backend/img/gift-package-4-BlP69XMS.png',
            ...
            [
                ...
                'image' => 'backend/img/gift-package-5-rCfev1FC.png',
            ...
            [
                ...
                'image' => 'backend/img/gift-package-6-6n7KKEot.png',
            ...
            [
                ...
                'image' => 'backend/img/gift-package-7-CcAYK3vq.png',
